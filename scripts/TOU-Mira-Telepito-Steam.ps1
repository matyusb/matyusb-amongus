...
function Confirm-InstallerNotice {
    ...
    Write-Host ''
    Write-Host 'FONTOS HITELESITESI TAJEKOZTATO' -ForegroundColor Yellow
    Write-Host 'A telepito elinditja a Valve hivatalos SteamCMD klienset.' -ForegroundColor Yellow
    Write-Host 'A Steam felhasznalonevet ez a telepito keri be.' -ForegroundColor Yellow
    Write-Host 'A SteamCMD ugyanebben a PowerShell-ablakban kerheti a Steam-jelszavadat' -ForegroundColor Yellow
    Write-Host 'es a Steam Guard ketlepcsos hitelesitesi kododat.' -ForegroundColor Yellow
    Write-Host 'A jelszot es a Steam Guard-kodot csak akkor add meg, amikor a SteamCMD keri.' -ForegroundColor Yellow
    Write-Host 'A PowerShell-telepito ezeket nem menti, nem naplozza es nem tovabbitja.' -ForegroundColor Yellow
    Write-Host 'Soha ne kuldd el ezeket a keszitonek, Discordon, e-mailben vagy hibajelentesben.' -ForegroundColor Yellow
    Write-Host ''
...
try {
    ...
    Write-Host ''
    Write-Host 'Most a Valve SteamCMD kliense indul el.' -ForegroundColor Cyan
    Write-Host 'A Steam-felhasznalonevet eloszor ez a telepito keri be.' -ForegroundColor Yellow
    Write-Host 'Ezutan a SteamCMD ugyanebben az ablakban kerheti a Steam-jelszot' -ForegroundColor Yellow
    Write-Host 'es a Steam Guard ketlepcsos hitelesitesi kodot.' -ForegroundColor Yellow
    Write-Host 'A telepito ezeket nem menti, nem naplozza es nem tovabbitja.' -ForegroundColor Yellow
    Write-Host ''
