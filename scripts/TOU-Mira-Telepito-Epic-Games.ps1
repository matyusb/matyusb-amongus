...
function Confirm-InstallerNotice {
    ...
    Write-Host ''
    Write-Host 'Ez a TOU Mira telepito nem keri be, nem menti es nem tovabbitja az Epic-jelszavadat vagy a ketlepcsos kododat.' -ForegroundColor Yellow
    Write-Host 'Az Epic-jelszavadat es a ketlepcsos hitelesitesi kodot csak az Epic hivatalos bejelentkezesi oldalan add meg.' -ForegroundColor Yellow
    Write-Host 'A telepito altal inditott EpicGamesDowngrader vagy Legendary ugyanebben az ablakban Epic engedelyezesi kodot kerhet.' -ForegroundColor Yellow
    Write-Host 'Az engedelyezesi kod nem az Epic-jelszavad; csak akkor illeszd be, amikor a downgrader vagy a Legendary keri.' -ForegroundColor Yellow
    Write-Host 'A hitelesitesi adatokat az EpicGamesDowngrader es a Legendary kulso komponensek kezelik.' -ForegroundColor Yellow
    Write-Host 'Jelszot vagy hitelesitesi kodot soha ne kuldj el a keszitonek, Discordon, e-mailben vagy hibajelentesben.' -ForegroundColor Yellow
    Write-Host ''
...
try {
    ...
    Write-Host 'A downgrader megnyithatja az Epic hivatalos bejelentkezesi oldalat.' -ForegroundColor Yellow
    Write-Host 'Az Epic-jelszot es a ketlepcsos kodot csak a bongeszoben, az Epic oldalan add meg.' -ForegroundColor Yellow
    Write-Host 'A bongeszo ezutan Epic engedelyezesi kodot adhat; ezt a downgrader kerdesere beillesztheted ebbe az ablakba.' -ForegroundColor Yellow
    Write-Host 'Az engedelyezesi kodot ne oszd meg massal, es ne tedd hibajelentesbe.' -ForegroundColor Yellow
